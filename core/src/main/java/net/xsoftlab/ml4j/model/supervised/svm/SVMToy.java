package net.xsoftlab.ml4j.model.supervised.svm;
...
public class SVMToy extends Applet {
	...
	private static final long serialVersionUID = 7592854998193598839L;
	...
	void button_run_clicked(String args) {
		...
		} else if (param.svm_type == Parameter.EPSILON_SVR || param.svm_type == Parameter.NU_SVR) {
			if (param.gamma == 0)
				param.gamma = 1;
			prob.x = new Node[prob.length][1];
...
class AppletFrame extends Frame {
	...
	private static final long serialVersionUID = 1385933153290346158L;
