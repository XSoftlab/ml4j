...
import net.xsoftlab.ml4j.model.supervised.svm.libsvm.PrintInterface;
...
class SVMTrain {
	...
	private void do_cross_validation() {
		...
		if (param.svm_type == Parameter.EPSILON_SVR || param.svm_type == Parameter.NU_SVR) {
			...
			System.out.print("Cross Validation Mean squared error = " + total_error / prob.length + "\n");
			...
			for (i = 0; i < prob.length; i++)
				if (target[i] == prob.y[i])
					++total_correct;
			System.out.print("Cross Validation Accuracy = " + 100.0 * total_correct / prob.length + "%\n");
		}
	}
